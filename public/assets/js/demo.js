...
toggleEdit.onclick = evt => {
  ...
  if (editing) {
    ...
    document.getElementById('form_builder_formbuilderhtml').innerHTML = document.getElementsByClassName('render-form')[0].innerHTML;
    document.getElementById("form_builder").submit();
  } else {
